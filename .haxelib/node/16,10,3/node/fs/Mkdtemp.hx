...
@:jsRequire("fs", "mkdtemp") @valueModuleOnly extern class Mkdtemp {
	...
	**/
	...
	@:overload(function(prefix:String, options:EncodingOption, callback:(err:Null<global.nodejs.ErrnoException>, folder:ts.AnyOf2<String, node.buffer.Buffer>) -> Void):Void { })
