...
@:jsRequire("tls", "Server") extern class Server extends node.net.Server {
	...
	**/
	...
	@:overload(function(event:String, listener:(sessionId:node.buffer.Buffer, sessionData:node.buffer.Buffer, callback:(err:js.lib.Error, resp:node.buffer.Buffer) -> Void) -> Void):Server { })
	...
	@:overload(function(event:String, listener:(sessionId:node.buffer.Buffer, callback:(err:js.lib.Error, sessionData:node.buffer.Buffer) -> Void) -> Void):Server { })
	...
	**/
	...
	@:overload(function(event:String, sessionId:node.buffer.Buffer, sessionData:node.buffer.Buffer, callback:(err:js.lib.Error, resp:node.buffer.Buffer) -> Void):Bool { })
	...
	@:overload(function(event:String, sessionId:node.buffer.Buffer, callback:(err:js.lib.Error, sessionData:node.buffer.Buffer) -> Void):Bool { })
