...
@:native("MSPointerEvent") extern class MSPointerEvent {
	...
	function initPointerEvent(typeArg:String, canBubbleArg:Bool, cancelableArg:Bool, viewArg:js.html.Window, detailArg:Float, screenXArg:Float, screenYArg:Float, clientXArg:Float, clientYArg:Float, ctrlKeyArg:Bool, altKeyArg:Bool, shiftKeyArg:Bool, metaKeyArg:Bool, buttonArg:Float, relatedTargetArg:js.html.EventTarget, offsetXArg:Float, offsetYArg:Float, widthArg:Float, heightArg:Float, pressure:Float, rotation:Float, tiltX:Float, tiltY:Float, pointerIdArg:Float, pointerType:Dynamic, hwTimestampArg:Float, isPrimary:Bool):Void;
	final altKey : Bool;
	final button : Float;
	final buttons : Float;
	final clientX : Float;
